...
private:
  ...
  void move_group_L(robot::MotorGroup mg, double pow, vex::velocityUnits units);
  void move_group_R(robot::MotorGroup mg, double pow, vex::velocityUnits units);
  void move_group(robot::MotorGroup mg, double pow,
